...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 left-0 h-full w-80 bg-white/5 backdrop-blur-xl border-r border-white/10 shadow-2xl transform transition-transform duration-300 z-50 ${
